...
static WORD iArrayOfBushouList[最大数::武将情報::配列数+1] = {0}; // 表示する対象となる武将リスト番号。最後は0xFFFFで終わりとみなす。
int iAdressOfArrayOfBushouList = (int)iArrayOfBushouList;
static int iFilterOptionOfSelectBushouDialog = カラム::武将::デフォルト;
...
// 対象となる武将リスト。
vector<int> _SelectBushouMultiDialog(vector<int> list, __int64 iFilterOption, int iSelectableMaxBushouNum ) {
